...
//                return 8;
		...
		case 0xF1:
			/*
			 * When setting AF it is important to zero out the lower for bits of the F
			 * register because it is *always* zero. The upper four bits are are written to
			 * when any of the flags need setting. So here, the lower four bits are zeroed
			 * out and the flags are set according to the bits of the upper 4.
			 */
		...
		case 0x9F:
			...
			return 4;
		case 0x98:
			register.A.setValue(cpu8BitSub(register.A, register.B, false, true));
			return 4;
		case 0x99:
		...
		case 0xCB:
			/*
			 * 0xCB itself takes 4 cycles to execute so add this to cycles taken by the
			 * extended opcode
			 */
	...
	private int executeExtendedOpcode() {
		...
		case 0x4F:
			...
			return 8;
		case 0x50:
			cpuTestBit(register.B.getValue(), 2);
			return 8;
		case 0x51:
...
//        }
	...
	/*
	 * TODO: Perhaps I don't need to return a value, since reg is of type UInt and
	 * is passed by reference. Have another look at this later.
	 */
